...
export default function ProjectCard({
  ...
  return (
    <div className="bg-white/10 backdrop-blur border border-white/20 rounded-2xl overflow-hidden shadow-lg hover:scale-[1.03] transition">
      ...
      <div className="p-6">
        ...
        <Link
          href={`/projects/${id}`}
          className="block text-center bg-blue-500 hover:bg-blue-600 transition rounded-lg py-2"
        >
          View Details →
        </Link>
      </div>
